...
* install qt6 (by aqt or installer from the qt website)
    ...
    aqt install-qt --outputdir ~/Qt mac desktop 6.7.1 clang_64 --external 7z
...
* install qt6 (by aqt or installer from the qt website)
    ...
    aqt install-qt --outputdir c:/Qt windows desktop 6.7.1 win64_msvc2019_64
    aqt install-qt --outputdir c:/Qt windows desktop 6.7.1 win64_mingw
...
* install qt6 (by aqt or installer from the qt website)
    ...
    aqt install-qt --outputdir ~/Qt linux desktop 6.7.1 linux_gcc_64 --external 7z
