...
IMPLEMENTER_SYSTEM = (
    ...
    "- File location: resolve user-described files with fs_hint_resolve (and fs_resolve_path as needed), then verify with fs_check_paths; avoid guessing full paths or repo-wide searches. For logs, prefer fs_tail_lines (or fs_tail_bytes) — simple and robust.\n"
