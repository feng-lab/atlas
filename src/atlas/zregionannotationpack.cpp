...
ZRegionAnnotationPack::ZRegionAnnotationPack(ZRegionAnnotation* ra,
                                             const QString& path,
                                             size_t id,
  ...
  , m_doc(doc)
{
  ...
  createContextMenu();
  connect(undoStack(), &QUndoStack::cleanChanged, this, &ZRegionAnnotationPack::undoStackCleanChanged);
...
void ZRegionAnnotationPack::createContextMenu()
{
  ...
  //
  //  m_transferSelectedPunctaToAnotherFileAction = new QAction(tr("Transfer Selected Puncta to Another File..."),
  //  this); m_transferSelectedPunctaToAnotherFileAction->setStatusTip(tr("Transfer the selected puncta to another
  //  puncta file")); connect(m_transferSelectedPunctaToAnotherFileAction, &QAction::triggered,
