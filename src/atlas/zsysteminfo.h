...
public:
  ...
  int maxNumRecentFiles() const { return 20; }
  void addFileToRecentFileList(const QString &fileName) const;

  QString lastOpenedImagePath() const { return lastOpenedObjPath("Image"); }
  void setLastOpenedImagePath(const QString &path) const { setLastOpenedObjPath("Image", path); }
