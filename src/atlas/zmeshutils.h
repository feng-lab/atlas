...
template<typename Real>
bool ZMeshUtils::isApproxEqual(const glm::tvec3<Real,glm::highp> &vertex1, const glm::tvec3<Real,glm::highp> &vertex2, Real epsilon)
{
  return glm::length(vertex1 - vertex2) <= epsilon;
}

template<typename Real>
Real ZMeshUtils::vertexPlaneDistance(const glm::tvec3<Real,glm::highp> &vertex, const glm::tvec4<Real,glm::highp> &plane, Real epsilon)
{
...
template<typename Real>
Real ZMeshUtils::vertexLineSquaredDistance(const glm::tvec3<Real,glm::highp> &x, const glm::tvec3<Real,glm::highp> &p1, const glm::tvec3<Real,glm::highp> &p2)
{
  Real proj, den;
...
template<typename Real>
Real ZMeshUtils::vertexLineSegmentSquaredDistance(const glm::tvec3<Real,glm::highp> &x, const glm::tvec3<Real,glm::highp> &p1, const glm::tvec3<Real,glm::highp> &p2,
                                                Real &t, glm::tvec3<Real,glm::highp> &closestPoint)
{
  Real denom, num;
...
template<typename Real>
bool ZMeshUtils::vertexInsideTriangle(const glm::tvec3<Real,glm::highp> &P, const glm::tvec3<Real,glm::highp> &A, const glm::tvec3<Real,glm::highp> &B,
                                    const glm::tvec3<Real,glm::highp> &C, Real epsilon, Real &u, Real &v)
{
  // Compute vectors
