...
double ZImageInterpolation::sample(const TPixel *img, size_t width, size_t height, double x, double y) const
{
  ...
  if (m_interpolant == Interpolant::Nearest) {
    ...
    vecTx[0] = 0.5; vecTx[1] = 0.5*tx; vecTx[2] = 0.5*tx*tx; vecTx[3] = 0.5*tx*tx*tx;
    vecTy[0] = 0.5; vecTy[1] = 0.5*ty; vecTy[2] = 0.5*ty*ty; vecTy[3] = 0.5*ty*ty*ty;
                                   ...
                                   double x, double y, double z) const
{
  ...
  if (m_interpolant == Interpolant::Nearest) {
    ...
    vecTx[0] = 0.5; vecTx[1] = 0.5*tx; vecTx[2] = 0.5*tx*tx; vecTx[3] = 0.5*tx*tx*tx;
    vecTy[0] = 0.5; vecTy[1] = 0.5*ty; vecTy[2] = 0.5*ty*ty; vecTy[3] = 0.5*ty*ty*ty;
    vecTz[0] = 0.5; vecTz[1] = 0.5*tz; vecTz[2] = 0.5*tz*tz; vecTz[3] = 0.5*tz*tz*tz;
...
template double ZImageInterpolation::sample<uint8_t>(const uint8_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<uint16_t>(const uint16_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<uint32_t>(const uint32_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<uint64_t>(const uint64_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<int8_t>(const int8_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<int16_t>(const int16_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<int32_t>(const int32_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<int64_t>(const int64_t *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<float>(const float *img, size_t width, size_t height, double x, double y) const;
template double ZImageInterpolation::sample<double>(const double *img, size_t width, size_t height, double x, double y) const;

template double ZImageInterpolation::sample<uint8_t>(const uint8_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<uint16_t>(const uint16_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<uint32_t>(const uint32_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<uint64_t>(const uint64_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<int8_t>(const int8_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<int16_t>(const int16_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<int32_t>(const int32_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<int64_t>(const int64_t *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<float>(const float *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
template double ZImageInterpolation::sample<double>(const double *img, size_t width, size_t height, size_t depth, double x, double y, double z) const;
