...
public:
  ...
  QString notSupportedReason() const { return m_notSupportedReason; }

  int glMajorVersion() const { return m_glMajorVersion; }
  int glMinorVersion() const { return m_glMinorVersion; }
  int glReleaseVersion() const { return m_glReleaseVersion; }
  ...
  int maxTextureImageUnits() const { return m_maxTextureImageUnits; }
  ...
  int maxVertexTextureImageUnits() const { return m_maxVertexTextureImageUnits; }
  ...
  // The value must be at least 16.
  int maxGeometryTextureImageUnits() const { return m_maxGeometryTextureImageUnits; }
  ...
  float maxTextureAnisotropy() const { return m_maxTextureAnisotropy; }

  // Returns the maximal number of color attachments for a FBO
  int maxColorAttachments() const { return m_maxColorAttachments; }
  int maxDrawBuffer() const { return m_maxDrawBuffer; }
  ...
  float smoothLineWidthGranularity() const { return m_smoothLineWidthGranularity; }
  float minAliasedLineWidth() const { return m_minAliasedLineWidth; }
  float maxAliasedLineWidth() const { return m_maxAliasedLineWidth; }
