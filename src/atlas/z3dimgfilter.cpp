...
Z3DImgFilter::Z3DImgFilter(Z3DGlobalParameters& globalParas, QObject* parent)
  ...
  , m_opaqueOutport("OpaqueImage", true, State::MonoViewResultInvalid)
  , m_opaqueLeftEyeOutport("OpaqueLeftEyeImage", true, State::LeftEyeResultInvalid)
  , m_opaqueRightEyeOutport("OpaqueRightEyeImage", true, State::RightEyeResultInvalid)
