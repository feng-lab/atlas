...
public:
  ...
  {
#ifdef CONFIG_OLD
    ShowHideNameColumn = 0, TypeColumn, InfoColumn, IDColumn, ShowHideColumn, LockColumn, NameColumn, ViewSettingColumn, ColumnCount
#else
  ...
  inline bool hasObj() const { return !m_rootItem->children.empty(); }
