                                                      ...
                                                      bool pickingPass)
{
  ...
  const float boxCorrection = computeBoxCorrection(glm::degrees(eyeState.fieldOfView));
  transforms.parameters = glm::vec4(sizeScale, eyeState.isPerspective ? 0.0f : 1.0f, boxCorrection, 0.0f);
