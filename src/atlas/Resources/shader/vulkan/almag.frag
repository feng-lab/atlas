...
void main()
{
    ...
    float distanceFactor = texture(atlas_bindlessSampler2DLinear(pc.atlas_texture), texCoord0).a;
    ...
    if (SHOW_SHADOW) {
        ...
        float glowDistance =
          texture(atlas_bindlessSampler2DLinear(pc.atlas_texture), texCoord0 + GLOW_UV_OFFSET).a;
