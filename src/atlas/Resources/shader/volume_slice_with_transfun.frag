...
#else
  chColor = texture1D(transfer_function_1, texture3D(volume_1, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
...
#else
  chColor = texture1D(transfer_function_2, texture3D(volume_2, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_3, texture3D(volume_3, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_4, texture3D(volume_4, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_5, texture3D(volume_5, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_6, texture3D(volume_6, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_7, texture3D(volume_7, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_8, texture3D(volume_8, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_9, texture3D(volume_9, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_10, texture3D(volume_10, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_11, texture3D(volume_11, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_12, texture3D(volume_12, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_13, texture3D(volume_13, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_14, texture3D(volume_14, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_15, texture3D(volume_15, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_16, texture3D(volume_16, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_17, texture3D(volume_17, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_18, texture3D(volume_18, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_19, texture3D(volume_19, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
...
#else
  chColor = texture1D(transfer_function_20, texture3D(volume_20, texCoord0).r);
#endif
  if (chColor.a > 0.0) {
    color = max(color, chColor);
  }
