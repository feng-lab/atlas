...
#else
  chColor = texture1D(colormap_1, texture3D(volume_1, texCoord0).r);
#endif
...
#else
  chColor = texture1D(colormap_2, texture3D(volume_2, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_3, texture3D(volume_3, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_4, texture3D(volume_4, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_5, texture3D(volume_5, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_6, texture3D(volume_6, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_7, texture3D(volume_7, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_8, texture3D(volume_8, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_9, texture3D(volume_9, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_10, texture3D(volume_10, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_11, texture3D(volume_11, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_12, texture3D(volume_12, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_13, texture3D(volume_13, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_14, texture3D(volume_14, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_15, texture3D(volume_15, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_16, texture3D(volume_16, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_17, texture3D(volume_17, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_18, texture3D(volume_18, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_19, texture3D(volume_19, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
...
#else
  chColor = texture1D(colormap_20, texture3D(volume_20, texCoord0).r);
#endif
  color = max(color, chColor);
#endif
