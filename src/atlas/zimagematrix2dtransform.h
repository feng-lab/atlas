...
public:
  ...
  void setTransform(const ZAffine2D &tform) { m_tform = tform; }
  void setRotationCenter(double x, double y) { m_centerX = x; m_centerY = y; }
...
public:
  ...
  virtual bool is2DTransform() const override { return true; }
