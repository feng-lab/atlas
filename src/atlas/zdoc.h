...
public:
  ...
  inline QUndoGroup* undoGroup() { return m_undoGroup; }
  void activateEmptyUndoStack();
  inline QAction* undoAction() { return m_undoAction; }
  inline QAction* redoAction() { return m_redoAction; }
  inline QAction* make2DAnimationAction() { return m_make2DAnimationAction; }
  inline QAction* make3DAnimationAction() { return m_make3DAnimationAction; }
  inline QAction* changeAnimationSettingAction() { return m_changeAnimationSettingAction; }
  ...
  inline size_t getNewObjId() { return m_nextObjId++; }
  ...
  ZImgDoc& imgDoc() { return *m_imgDoc; }
