...
Z3DCompositor::Z3DCompositor(Z3DGlobalParameters& globalParas, QObject* parent)
  ...
  , m_inport("Image", true, State::MonoViewResultInvalid)
  , m_leftEyeInport("LeftEyeImage", true, State::LeftEyeResultInvalid)
  , m_rightEyeInport("RightEyeImage", true, State::RightEyeResultInvalid)
  , m_outport("Image", true, State::MonoViewResultInvalid)
  , m_leftEyeOutport("LeftEyeImage", true, State::LeftEyeResultInvalid)
  , m_rightEyeOutport("RightEyeImage", true, State::RightEyeResultInvalid)
  , m_tempPort("ImageTemp")
  , m_tempPort2("ImageTemp2")
  , m_tempPort3("ImageTemp3")
  , m_tempPort4("ImageTemp4")
  , m_tempPort5("ImageTemp5")
  , m_pickingPort("PickingTarget", true, State::AllResultInvalid, GLint(GL_RGBA8))
