...
public:
  ...
  // Resize XY and set Z for layered attachments (2D array / 3D / cube map array).
  // Non-layered attachments are kept at Z=1. Returns true if any change was applied.
  bool resize(const glm::uvec3& newdim);
