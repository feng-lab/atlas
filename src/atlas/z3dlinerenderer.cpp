    ...
    if (linesInput) {
      ...
      if (m_isLineStrip) {
        for (size_t i=1; i<linesInput->size(); ++i) {
          m_smoothLineP0s.push_back(linesInput->at(i-1));
          m_smoothLineP0s.push_back(linesInput->at(i-1));
          m_smoothLineP0s.push_back(linesInput->at(i-1));
          m_smoothLineP0s.push_back(linesInput->at(i-1));
        ...
        for (size_t i=0; i+1<linesInput->size(); i+=2) {
          m_smoothLineP0s.push_back(linesInput->at(i));
          m_smoothLineP0s.push_back(linesInput->at(i));
          m_smoothLineP0s.push_back(linesInput->at(i));
          m_smoothLineP0s.push_back(linesInput->at(i));
...
void Z3DLineRenderer::compile()
{
  ...
  if (m_useGeomLineShader)
    m_smoothLineShaderGrp.rebuild(m_rendererBase.generateHeader() + generateHeader(), m_rendererBase.generateGeomHeader() + generateHeader());
  else
