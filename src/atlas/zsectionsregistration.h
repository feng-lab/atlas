...
public:
  ...
  // will be used.
  void setReferenceChannel(int ch) { m_referenceChannel = ch; }

  // some preprocess before registration
  // default is true
  void setRemoveBackground(bool v) {  m_removeBackground = v; }
  // default is true
  void setRemoveHighForeground(bool v) { m_removeHighForeground = v; }
  // default is false
  void setAllowFlip(bool v) { m_allowFlip = v; }
  // default is false
  void setBrightBackground(bool v) { m_brightBackground = v; }
  // registration methods
  //
  void setMetric(const QString &str) { m_metric = str; }
  //
  void setTransform(const QString &str) { m_transform = str; }
  //
  void setOptimizer(const QString &str) { m_optimizer = str; }

  // default is true
  void setUseMultithreading(bool i) { m_useMultithreading = i; }

  // use multiscale registration if number of scale > 1, default is 1
  void setNumScales(int i) { m_numScales = i; }

  // registrate between s, s+1, ..., s+i, s-1, ..., s-i
  void setNumNeighbors(int i) { m_numNeighbors = i; }
