...
public:
  ...
  ZColorMap(double min,
            ...
            const QColor& maxColor = QColor(0, 0, 0, 255),
            QObject* parent = nullptr);
  ...
  void reset(double min = 0.0,
             double max = 255.0,
             const glm::col4& minColor = glm::col4(0, 0, 0, 255),
             const glm::col4& maxColor = glm::col4(255, 255, 255, 255));

  template<class ForwardIterator>
  void reset(ForwardIterator first,
             ForwardIterator last,
             const glm::col4& minColor = glm::col4(0, 0, 0, 255),
             const glm::col4& maxColor = glm::col4(255, 255, 255, 255));
...
template<class ForwardIterator>
ZColorMap::ZColorMap(const ForwardIterator first,
...
template<class ForwardIterator>
void ZColorMap::reset(const ForwardIterator first,
                      const ForwardIterator last,
                      const glm::col4& minColor,
                      const glm::col4& maxColor)
{
...
public:
  ...
  template<class ForwardIterator>
  ZColorMapParameter(const QString& name,
