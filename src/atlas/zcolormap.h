...
public:
  ...
  inline glm::col4 colorL() const {return m_colorL;}
  ...
  inline glm::col4 colorR() const {return m_colorR;}
...
public:
  ...
  glm::dvec2 domain() const { return glm::dvec2(domainMin(), domainMax()); }
  ...
  inline size_t numKeys() const {return m_keys.size();}
  inline ZColorMapKey& key(size_t index) {return m_keys.at(index).first;}
  inline bool hasDataRange() const {return m_hasDataRange;}
  inline double dataMin() const {return m_dataMin;}
  inline double dataMax() const {return m_dataMax;}
...
class ZColorMapParameter : public ZSingleValueParameter<ZColorMap>
{
  Q_OBJECT
public:
  ZColorMapParameter(const QString &name, QObject *parent = NULL);
  ZColorMapParameter(const QString &name, const ZColorMap& cm, QObject *parent = NULL);
  ...
  ZColorMapParameter(const QString& name, const ForwardIterator first, const ForwardIterator last, const glm::col4 &minColor = glm::col4(0,0,0,255),
                     const glm::col4 &maxColor = glm::col4(255,255,255,255), QObject *parent = NULL);
  ...
  ZColorMapParameter(const QString& name, const ForwardIterator first, const ForwardIterator last, const glm::vec4 &minColor = glm::vec4(0.f,0.f,0.f,1.f),
                     const glm::vec4 &maxColor = glm::vec4(1.f,1.f,1.f,1.f), QObject *parent = NULL);
...
template<class ForwardIterator>
ZColorMapParameter::ZColorMapParameter(const QString& name, const ForwardIterator first, const ForwardIterator last, const glm::col4 &minColor, const glm::col4 &maxColor, QObject *parent)
...
template<class ForwardIterator>
ZColorMapParameter::ZColorMapParameter(const QString& name, const ForwardIterator first, const ForwardIterator last, const glm::vec4 &minColor, const glm::vec4 &maxColor, QObject *parent)
  : ZSingleValueParameter<ZColorMap>(name, parent)
{
  m_value.reset(first, last, minColor, maxColor);
  connect(&m_value, SIGNAL(changed()), this, SIGNAL(valueChanged()));
...
template<class ForwardIterator>
ZColorMapParameter::ZColorMapParameter(const QString& name, const ForwardIterator first, const ForwardIterator last, const QColor &minColor, const QColor &maxColor, QObject *parent)
  : ZSingleValueParameter<ZColorMap>(name, parent)
{
  m_value.reset(first, last, minColor, maxColor);
  connect(&m_value, SIGNAL(changed()), this, SIGNAL(valueChanged()));
