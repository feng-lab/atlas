...
public:
  ...
  static ZMesh createCubesWithNormal(const std::vector<glm::vec3>& coordLlfs, const std::vector<glm::vec3>& coordUrbs);

  // a cube with six surfaces
  static ZMesh createCube(const glm::vec3& coordLlf = glm::vec3(0.f, 0.f, 0.f),
  ...
  static ZMesh createCubeSlice(float coordIn3rdDim,
  ...
  // one slice from a cube, it is a x slice if alongDim == 0, a y slice if alongDim == 1,
  // a z slice if alongDim == 2
  static ZMesh createCubeSliceWith2DTexture(float coordIn3rdDim,
                                            int alongDim = 2, // 0, 1, or 2
                                            const glm::vec2& coordlow = glm::vec2(0.f, 0.f),
                                            const glm::vec2& coordhigh = glm::vec2(1.f, 1.f),
                                            const glm::vec2& texlow = glm::vec2(0.f, 0.f),
  ...
  static ZMesh createImageSlice(float coordIn3rdDim,
                                const glm::vec2& coordlow = glm::vec2(0.f, 0.f),
                                const glm::vec2& coordhigh = glm::vec2(1.f, 1.f),
                                const glm::vec2& texlow = glm::vec2(0.f, 0.f),
                                const glm::vec2& texhigh = glm::vec2(1.f, 1.f));
  ...
  static ZMesh createCubeSerieSlices(int numSlices,
                                     int alongDim = 2, // 0, 1, or 2
  ...
  static ZMesh createSphereMesh(const glm::vec3& center,
                                float radius,
                                int thetaResolution = 32,
                                int phiResolution = 32,
                                float startTheta = 0.f,
                                float endTheta = 360.f,
                                float startPhi = 0.f,
                                float endPhi = 180.f);

  static ZMesh createTubeMesh(const std::vector<glm::vec3>& line,
                              const std::vector<float>& radius,
                              int numberOfSides = 32,
                              bool capping = true);

  static ZMesh createConeMesh(glm::vec3 base,
                              float baseRadius,
                              glm::vec3 top,
                              float topRadius,
                              int numberOfSides = 32,
  ...
  static void createSwcMesh(const ZSwc& tree,
                            int rootType,
                            ZMesh& rootMesh,
                            ZMesh& somaMesh,
                            ZMesh& branchMesh,
  ...
  static void createPunctaMesh(const ZPuncta& puncta,
                               ZMesh& punctaMesh,
                               int resolution = 32,
                               const glm::mat4& tfmat = glm::mat4(1.f));
  ...
  ZImg toLabelImg(size_t width = 0,
                  size_t height = 0,
                  size_t depth = 0,
                  const glm::mat4& tfmat = glm::mat4(1.f),
...
private:
  ...
  [[nodiscard]] double signedVolumeOfTriangle(const glm::vec3& v1, const glm::vec3& v2, const glm::vec3& v3) const;
