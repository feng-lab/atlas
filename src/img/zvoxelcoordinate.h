...
struct ZVoxelCoordinate
{
  ...
  inline const value_type& operator[](size_t i) const { return (&x)[i]; }
  ...
  {
    x += rhs; y += rhs; z += rhs; c += rhs; t += rhs; return *this;
  }
  inline ZVoxelCoordinate& operator+=(const ZVoxelCoordinate& rhs)
  {
    x += rhs.x; y += rhs.y; z += rhs.z; c += rhs.c; t += rhs.t; return *this;
  }
  inline ZVoxelCoordinate& operator-=(value_type rhs)
  {
    x -= rhs; y -= rhs; z -= rhs; c -= rhs; t -= rhs; return *this;
