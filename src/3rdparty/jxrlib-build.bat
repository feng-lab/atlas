...
MSBuild.exe JXR_vc12.sln /target:JXRDecApp /property:Platform=x64 /property:Configuration=Release /property:ForceImportBeforeCppTargets=%currDIR%\runtime_md.props /maxcpucount
...
robocopy %srcDIR%\image\vc12projects\Release\JXRCommonLib\x64 %installDIR%\lib *.lib
robocopy %srcDIR%\image\vc12projects\Release\JXRDecodeLib\x64 %installDIR%\lib *.lib
robocopy %srcDIR%\image\vc12projects\Release\JXREncodeLib\x64 %installDIR%\lib *.lib
