...
set(SKIA_INCLUDE_DIRS ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/build/include/skia)
if (WIN32)
  set(SKIA_LIBRARIES ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/build/lib/skia/skia.lib)
else ()
  set(SKIA_LIBRARIES ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/build/lib/skia/libskia.a)
endif ()
...
if (BUILD_WITH_CONDA)
  find_package(Qt5 ${QT_VERSION} REQUIRED COMPONENTS Core PATHS ${QT_HOST_PATH} NO_DEFAULT_PATH)
  print_target_properties(Qt5::Core)
  set(_QT_LIBS_ Qt5::Core)
else ()
