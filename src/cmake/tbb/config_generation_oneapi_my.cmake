...
")
    ...
    elseif (tbb_gen_cfg_SYSTEM_NAME STREQUAL "Windows")
        ...
        set(TBB_IMPLIB_RELEASE "
                                      IMPORTED_IMPLIB_RELEASE \"\${TBB_LIB_REL_PATH}/\${_tbb_subdir}/\${_tbb_component}\${_bin_version}.lib\"")
        set(TBB_IMPLIB_DEBUG "
                                      IMPORTED_IMPLIB_DEBUG \"\${TBB_LIB_REL_PATH}/\${_tbb_subdir}/\${_tbb_component}\${_bin_version}_debug.lib\"")
...
")
    ...
    configure_file(${_tbb_gen_cfg_path}/templates/TBBConfig_my.cmake.in ${config_install_dir}/TBBConfig.cmake @ONLY)
