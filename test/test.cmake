...
macro(add_atlas_gtest_executable test_name)
  ...
  target_compile_definitions(${test_name} PRIVATE ATLAS_TEST_DATA_DIR="${CMAKE_CURRENT_LIST_DIR}/../atlas_test_data")
  if (UNIX AND NOT APPLE AND ATLAS_USE_LLD_LINKER AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND DEFINED ATLAS_LLD_FLAG)
    target_link_options(${test_name} PRIVATE ${ATLAS_LLD_FLAG})
  endif ()
  gtest_discover_tests(${test_name} DISCOVERY_TIMEOUT 600)
endmacro()
...
if (UNIX AND NOT APPLE AND ATLAS_USE_LLD_LINKER AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND DEFINED ATLAS_LLD_FLAG)
  target_link_options(zbenchmark PRIVATE ${ATLAS_LLD_FLAG})
endif ()
