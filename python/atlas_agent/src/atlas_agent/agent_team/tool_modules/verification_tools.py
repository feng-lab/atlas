...
TOOL_SPECS: List[Dict[str, Any]] = [
    {
        ...
        "function": {
            ...
            "description": "Return verification requirements + current verification status for the current plan steps.",
            "parameters": {
                "type": "object",
                "properties": {
                    "include_plan": {
                    ...
                    "steps": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                "step_id": {
                                    "type": ["string", "null"],
                                    "description": "Plan step id (preferred).",
                                },
                                "step": {
                                    "type": ["string", "null"],
                                    "description": "Plan step text (fallback lookup if step_id omitted).",
                                },
                                "policy": {
                                    "type": "object",
                                    "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Evaluate whether each plan step's verification policy is satisfied by current verification statuses.",
            "parameters": {
                "type": "object",
                "properties": {},
                "additionalProperties": False,
